...
(1, 'Tech Solutions', 'Empresa líder em soluções de software para o mercado brasileiro.', 'São Paulo', 'SP', 'Tecnologia'),
(2, 'InovaCorp', 'Startup de inovação focada em IA e Machine Learning.', 'Rio de Janeiro', 'RJ', 'Inteligência Artificial'),
(3, 'StartupBR', 'Aceleradora de startups com foco em fintech e edtech.', 'Belo Horizonte', 'MG', 'Fintech');

INSERT INTO alunos (usuario_id, curso, universidade, semestre, cidade, estado) VALUES
(4, 'Ciência da Computação', 'USP', 6, 'São Paulo', 'SP');
