<?php
$pageTitle = 'Admin — InternSHIP Conect';
...
<div class="container" style="max-width:1100px;padding:32px 24px;">
  <div class="dashboard-header">
    ...
    <p>Visão geral da plataforma e moderação</p>
  </div>
  ...
  <div class="kpi-grid">
    ...
    <div class="kpi-card">
      <div class="kpi-top">
        <div><div class="kpi-num" style="color:<?= $inativos ? 'var(--danger)' : 'var(--gray-700)' ?>;"><?= $inativos ?></div><div class="kpi-label">Usuários inativos</div></div>
      </div>
    </div>
  </div>

  <div class="card mb-6">
    <div class="card-header"><h3>Áreas de moderação</h3></div>
