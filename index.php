<?php
$pageTitle = 'IntenSHIP Conect — Início';
...
?>
<div class="container">
  <h1>IntenSHIP Conect</h1>
  <p style="margin-top:8px;">Plataforma de estágios. Atualmente <strong><?= $totalVagas ?></strong> vagas ativas.</p>
  <a href="/estagios/etapas/01-base-e-vagas-publicas/vagas.php" class="btn" style="margin-top:16px;">Ver todas as vagas</a>
</div>
