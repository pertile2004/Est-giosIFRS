...
if (isLoggedIn()) {
    header('Location: /estagios/etapas/01-base-e-vagas-publicas/');
    exit;
}
...
<div class="container">
  <div class="card" style="max-width:400px;margin:48px auto;">
    ...
    <p style="text-align:center;margin-top:12px;">Não tem conta? <a href="/estagios/etapas/01-base-e-vagas-publicas/register.php">Criar conta</a></p>
  </div>
</div>
