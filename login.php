  ...
  <div class="auth-right">
    <div class="auth-form-wrap">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
        <a class="btn btn-ghost" href="/teste/auth/google.php" style="justify-content:center;">
        ...
        <a class="btn btn-ghost" href="/teste/auth/github.php" style="justify-content:center;">
